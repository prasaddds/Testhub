...
import Filteration from '../TEST/Filteration';
    ...
    <div className="profile-test-container">
      <div className="profile-test">
        <div className=" profile-test-btns">
            <button onClick={(e)=>setOption("filteration")}>score Filteration</button>
        ...
        <div className="profile-test-display">
          {
            option==="filteration"?<Filteration/>:option==="addtest"?<AddTest/>:option==="createdtests"?<Createdtest/>:" "
          }
        </div>
      </div>
    </div>
